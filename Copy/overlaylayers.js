...
var My_Interest_Ptos_Sendero = L.geoJson(null, {
    style: stylePoint,
    pointToLayer: PointToLayer,
    onEachFeature: PopupInfo,
    filter: function (feature, layer) {
...
markers2.addLayer(My_Interest_Ptos_Sendero);
...
var patrimonio = {
    //"Oficina de Turismo": geojsonOficina,
    "<img src='assets/img/icon/theater.png' width='24' height='28'>&nbsp;Theaters": My_Interest_Ptos_Natural,
    "<img src='assets/img/2.png'>  Pto. Interés Paisajístico": My_Interest_Ptos_Paisajistico,
    "<img src='assets/img/3.png'>  Pto. Interés Etnográfico": My_Interest_Ptos_Etnografico,
    "<img src='assets/img/3.png'>  Pto. Interés Sendero": My_Interest_Ptos_Sendero,
    "<img src='assets/img/3.png'>  Pto. Interés Arqueológico": My_Interest_Ptos_Arqueologico,
    "<img src='assets/img/3.png'>  Pto. Interés Infraestructura": My_Interest_Ptos_Infraestructura,

};

var controlCapas = L.control.layers(basemaps, patrimonio, {
